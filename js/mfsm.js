...
function setText() {
    ...
    // SECTION 1.3: HISTORY
    document.getElementById("history_header_1").innerHTML = museum_text;
    document.getElementById("history_header_2").innerHTML = history_text_uc;
    ...
    // document.getElementById("kidsBTN").innerHTML = kids_text;
    ...
    document.getElementById("mainExhibit_header_1").innerHTML = main_text;
    document.getElementById("mainExhibit_header_2").innerHTML = exhibit_text;
    ...
    document.getElementById("sculpture_garden_header_1").innerHTML = garden_text;
    document.getElementById("sculpture_garden_header_2").innerHTML = exhibit_text;
